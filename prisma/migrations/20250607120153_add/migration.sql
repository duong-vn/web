...
CREATE TABLE [dbo].[groups] (
    ...
    [number_of_posts] INT CONSTRAINT [DF__groups__number_o__145C0A3F] DEFAULT 1,
    [number_of_members] INT CONSTRAINT [DF__groups__number_o__15502E78] DEFAULT 1,
    ...
    CONSTRAINT [groups_group_name_key] UNIQUE NONCLUSTERED ([group_name])
);

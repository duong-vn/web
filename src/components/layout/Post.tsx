...
import { deleteReaction, getReactionsByPostId, isLikePost, postCreateReactionByPostId } from "@/app/services/apiServices";
  ...
  return (
    <div className="max-w-3xl mx-auto bg-gray-800 rounded-2xl shadow-lg overflow-hidden mb-6 border border-gray-700 hover:shadow-xl transition-all duration-300">
      <div className="p-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center text-sm text-gray-400 mt-1">
              <div className="flex items-center">
                ...
                />
                <span className="ml-2 font-medium text-gray-300 cursor-pointer hover:text-indigo-400" onClick={()=>{router.push(`/users/${data.user_id}`)}}>{data.username}</span>
              </div>
        ...
        {/* Post Image */}
        {data.image != null && (
          <div className="mb-6 rounded-xl max-h-150 overflow-x-hidden ">
            <img 
              src={data.image} 

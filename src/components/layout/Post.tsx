      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            <span className="text-lg font-bold text-gray-100 cursor-pointer hover:text-indigo-400 transition-colors duration-200">
              {data.group_name}
            </span>
            <div className="flex items-center text-sm text-gray-400 mt-1">
              <div className="flex items-center">
                ...
                />
                <span className="ml-2 font-medium text-gray-300">{data.username}</span>
              </div>

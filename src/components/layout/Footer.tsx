        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300">
              We are dedicated to providing the best content and services to our users.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=100022053741307" target="_blank" className="text-gray-300 hover:text-white">

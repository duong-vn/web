...
import { GROUP_IMAGE, USER_IMAGE } from "../utils/constants";
// const mockData = {
      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            <span className="text-lg font-semibold text-gray-900 cursor-pointer hover:underline hover:text-gray-300">
              {data.group_name}
            </span>
            <div className="flex items-center text-sm text-gray-500">
              <img
                ...
                alt={data.username}
                className="h-4 w-4 object-cover rounded-lg ml-1 mr-2"
              />
        ...
        {data.image != null && (
          <div className="mb-4">
            <img src={data.image} className="w-full rounded-lg object-cover" />
          </div>
        )}
        ...
        <div className="mt-4">
          ...
          <Comments post_id={data.post_id} curUser={curUser} />
        </div>
      </div>
    </div>
  );

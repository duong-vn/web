...
const createPost = async () => {
    ...
    return (
    <div className=" ml-75 border border-gray-300 w-225 max-h-100 flex gap-2 rounded-md  justify-center bg-white shadow-md mt-4 text-align">
    <div className= "p-4  flex flex-col">
                <div className="post-header flex flex-row gap-2">
                    <img src={data.group_image}
                    
                        className ="h-12 w-12 object-cover rounded-lg"
                    />
                    <div className=" flex flex-col user-time-privacy ">
                        <span className="group-name text-black font-bold">{data.group_name}</span>

                        <span className="text-sm ml-5  text-gray-500 items-center   "> 
                            {data.username} 
                            <span> • </span>
                              {data.created_at}
                              <span> • </span>
                              <span className="mb-[2.5]">
                                { data.privacy == 'Public'?  (<MdOutlinePublic className="inline w-4 h-4" />) :
                                (<RiGitRepositoryPrivateFill className="inline w-4 h-4"/>)
                ...
                <div className="content pt-3 text-black break-words whitespace-normal">
                                    {data.content} 
                </div>
                <div className="post-image items-center item-middle">
        ...
        <div   className="w-[1px] bg-gray-300 mx-4 text-black"></div>
                             
                             
                              <div className = "comment-container pt-2 gap-2 text-black w-100  flex flex-col border-gray-300 overflow-y-auto">
